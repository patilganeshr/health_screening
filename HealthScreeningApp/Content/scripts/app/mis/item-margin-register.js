...
SharpiTech.ItemMargin = (function () {
    ...
    function cacheDOM() {
        ...
        DOM.itemMarginList = document.getElementById('ItemMarginList');
    ...
    function getReportData() {
        ...
        try {
            ...
            shared.sendRequest(SERVICE_PATH + "GetItemMarginByCategorywiseQualitywiseCostwise/", "GET", true, "JSON", null, function (response) {
    ...
    function bindReportData() {
        ...
        if (itemMarginList.length > 0) {
            ...
            if (DOM.itemMarginList.hasChildNodes('thead')) {
                if (DOM.itemMarginList.tHead !== null) {
                    DOM.itemMarginList.tHead.remove();
                }
            }

            if (DOM.itemMarginList.hasChildNodes('tbody')) {
                if (DOM.itemMarginList.tBodies.length ) {
                    DOM.itemMarginList.tBodies[0].remove();
                }
            }

            var tableHeader = createTableHeader(itemMarginList, excludeListOfTableHeaders);

            var tableBody = createTableBody(itemMarginList, excludeListOfTableHeaders);

            DOM.itemMarginList.appendChild(tableHeader);

            DOM.itemMarginList.appendChild(tableBody);            
        }
    }
    ...
    function fnExcelReport() {
        ...
        tab = DOM.itemMarginList; // id of table
