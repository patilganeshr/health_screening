...
Sofarch.Prescription = (function () {
    ...
    function cacheDOM() {
        ...
        DOM.DocName = document.getElementById('txtDOCName');
    ...
    function bindEvents() {
        ...
        DOM.printDrugDispenseDetails.addEventListener('click', printDrugDispenseDetails);
    ...
    function getDrugDetailsByDrugId(drugId) {
        ...
        if (drugId > 0) {
            ...
            shared.sendRequest(SERVICE_PATH + "GetDrugDetailsByDrugIds/" + drugId, "GET", true, "JSON", null, function (response) {
                ...
                swal({
                    ...
                    function (isConfirm) {
                        ...
                        if (isConfirm) {
                            ...
                            shared.sendRequest(SERVICE_PATH + 'SaveDrugDispenseDetail', "POST", true, "JSON", postData, function (response) {
    ...
    function searchDrugDispenseDetails() {
        ...
        shared.sendRequest(SERVICE_PATH + "SearchDrugDispenses/", "POST", true, "JSON", postData, function (response) {
    ...
    function bindDrugDispenseDetails() {
        ...
        if (DrugDispenseDetails.length) {
            ...
            for (var r = 0; r < DrugDispenseDetails.length; r++) {
                ...
                data = data + "<td>" + DrugDispenseDetails[r].DoctName + "</td>";
    ...
    function getDrugDetailsByDrugDispenseId(e) {
        ...
        if (drugDispenseId > 0) {
            ...
            shared.sendRequest(SERVICE_PATH + "GetDrugUtilisationByDrugDispenseIds/" + drugDispenseId, "GET", true, "JSON", null, function (response) {
    ...
    function showDrugDispenseDetailsById(drugDispenseId) {
        ...
        if (DrugDispenseDetails.length) {
            ...
            if (drugDispenseDetails.length) {
                ...
                DOM.DocName.value = drugDispenseDetails[0].DoctName;
    ...
    var saveDrugUtilisationDetails = function () {
        ...
        if (tableRows.length) {
            ...
            for (var tr = 0; tr < tableRows.length; tr++) {
                ...
                var dosageInput = tableRows[tr].children[4].children[0];
    ...
    function printDrugDispenseDetails() {
                ...
                if (response.responseText !== undefined) {
                    ...
                    if (_response !== undefined) {
                        ...
                        if (_response.length > 0) {
                            ...
                            window.open(location.origin + "/HealthScreeningApp/ApplicationFiles/PatientNo/PatientNo_" + drugDispenseId + ".pdf", "_blank");
