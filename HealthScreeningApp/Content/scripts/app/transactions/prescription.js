...
Sofarch.Prescription = (function () {
    ...
    function cacheDOM() {
        ...
        DOM.deletePrescription = document.getElementById('DeleteEPrescription');
    ...
    function bindEvents() {
        ...
        //DOM.deletePrescription.addEventListener('click', deleteDrug);
    ...
    function viewPrescription() {
        ...
        if (selectedRows.length > 0) {
            ...
            if (selectedRows.length > 1) {
                ...
                var PrecautionsId = parseInt(currentTableRow.getAttribute('data-brand-id'));
    ...
    function bindPrec() {
        ...
        if (Prescription.length > 0) {
            ...
            for (var r = 0; r < Prescription.length; r++) {
                ...
                data += "<tr data-brand-id=" + Prescription[r].PrecautionsId + ">";
        ...
        if (Prescription.length > 0) {
            ...
            for (var c = 0; c < Prescription.length; c++) {
                ...
                if (Prescription[c].PrecautionsId === PrecautionsId) {
                    ...
                    DOM.docName.setAttribute('data-brand-id', PrecautionsId);
